  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="card">
        ...
        <div onSubmit={handleRequestSubmit} className="space-y-4">
          <div className="form-group">
          ...
          <button type="submit" className="btn btn-primary" onClick={handleRequestSubmit}>
            Submit Request
          </button>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div onSubmit={handleMessageSubmit} className="space-y-4 mb-6">
          <div className="form-group">
          ...
          <button type="submit" className="btn btn-secondary" onClick={handleMessageSubmit}>
            Send Message
          </button>
        </div>
